...
public class PieceMover : MonoBehaviour {
    ...
    private void ReturnPiece() {
        ...
        var rt = piece.GetComponent<RectTransform>();
            ...
            rt.SetInsetAndSizeFromParentEdge(RectTransform.Edge.Left, 0,
                rt.parent.GetComponent<RectTransform>().sizeDelta.x);
            rt.SetInsetAndSizeFromParentEdge(RectTransform.Edge.Top, 0,
                rt.parent.GetComponent<RectTransform>().sizeDelta.y);
